 ...
 *
 * <p>
 * <strong>Full disclosure:</strong> this class provides untrusted input and
 * output streams with raw access to the underlying byte array. A hostile stream
 * implementation could keep a reference to the mutable byte string, violating
 * the immutable guarantee of this class. For this reason a byte string's
 * immutability guarantee cannot be relied upon for security in applets and
 * other environments that run both trusted and untrusted code in the same
 * process.
 */
public final class ByteString {
	...
	public static ByteString encodeUtf8(String s) {
		ByteString byteString = new ByteString(s.getBytes(Charset.forName("UTF-8")));
		byteString.utf8 = s;
		return byteString;
	}
	...
	public String utf8() {
		...
		return result != null ? result : (utf8 = new String(data, Charset.forName("UTF-8")));
	}
	 ...
	 *             if {@code in} has fewer than {@code count} bytes to read.
	 */
