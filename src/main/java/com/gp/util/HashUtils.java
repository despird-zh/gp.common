...
public class HashUtils {
	...
	public static String hashEncodeBase64(String password, String salt) throws IllegalArgumentException{
		
		byte[] hashbytes = HashUtils.hash(password.toCharArray(), salt.getBytes(StandardCharsets.UTF_8));
